...
class SettingsMenuPage extends AbstractMenuPage
{
	...
	private function _generateGeneralTab()
	{
		...
		$pagesGroupFields = array(
			...
			Fields\FieldFactory::create(
				'mphb_dayuse_search_results_page',
				array(
					'type' => 'page-select',
					'label' => __('Search Results Page Dayuse', 'motopress-hotel-booking'),
					'description' => __('Select page to display Dayuse search results. Use Dayuse search results shortcode on this page.', 'motopress-hotel-booking'),
					'default' => '',
				)
			),

			Fields\FieldFactory::create(
				'mphb_dayuse_checkout_page',
				array(
					'type' => 'page-select',
					'label' => __('Checkout Page Dayuse', 'motopress-hotel-booking'),
					'description' => __('Select page user will be redirected to complete Dayuse booking.', 'motopress-hotel-booking'),
					'default' => '',
				)
			),
			Fields\FieldFactory::create(
		...
		$miscGroupFields = array(
			...
			Fields\FieldFactory::create(
				'mphb_check_in_time_day_use',
				array(
					'type' => 'timepicker',
					'label' => __('Check-in Time (Day Use)', 'motopress-hotel-booking'),
					'default' => '08:00',
				)
			),
			Fields\FieldFactory::create(
				'mphb_check_out_time_day_use',
				array(
					'type' => 'timepicker',
					'label' => __('Check-out Time (Day Use)', 'motopress-hotel-booking'),
					'default' => '18:00',
				)
			),
			Fields\FieldFactory::create(
